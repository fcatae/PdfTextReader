...
{
    class AnalyzeTreeStructureFontSize2 : ILogStructure2<TextSegment>
    {
        ...
        public void Log(TextWriter input, TextSegment artigo)
        {
            ...
            while (titles.Length > _currentTree.Count)
            {
                ...
                string fontSize = $"({titles[nivel].FontName} {titles[nivel].FontSize} {titles[nivel].FontStyle})";
                ...
                input.WriteLine( title + optPageInfo + fontSize );
            }
