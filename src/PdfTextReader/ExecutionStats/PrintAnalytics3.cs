...
{
    abstract class PrintAnalytics3
    {
        ...
        public class ShowTextLine : PrintAnalytics3, ILogStructure<TextLine>
        {
        ...
        public class ShowTextStructure : PrintAnalytics3, ILogStructure<TextStructure>
        {
            public override void StartLog(TextWriter analytics)
            {
                base.StartLog(analytics);
        ...
        public class ShowConteudo : PrintAnalytics3, ILogStructure<Conteudo>
        {
            public override void StartLog(TextWriter analytics)
            {
                base.StartLog(analytics);
