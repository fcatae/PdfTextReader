function calendarHeatmap() {
  ...
  var data = [];
  var max = null;
  var colorRange = ['#D8E7E6', '#218083'];
  var tooltipEnabled = true;
  var tooltipUnit = [{min:0,max:1,unit:'publicação'},{min:2,max:'Infinity',unit:'publicações'}];
      ...
      locale.days.forEach(function (day, index) {
        ...
        if (index % 2) {
          svg.append('text')
            ...
            .attr('transform', 'translate(-18,' + (SQUARE_LENGTH + SQUARE_PADDING) * (index + 1) + ')')
